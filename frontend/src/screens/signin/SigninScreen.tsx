...
import { googleLogin, login, facebookLogin } from "../../actions/userActions";
...
function SigninScreen() {
  ...
  const testLoginHandler = () => {
    dispatch(login("ghost@gmail.com", "12345"));
  };
          ...
          <div className="loginContainer">
            <div className="loginLeft">
              ...
              <div className="loginDetail">
                ...
                <p className="description">New to Amazon?</p>
                <div className="line2"></div>
              </div>

              <Link to="/register" className="detailsButton">
            ...
            <div className="loginRight">
              ...
              <div className="loginOption test" onClick={testLoginHandler}>
